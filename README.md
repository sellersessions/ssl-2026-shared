...
![Speakers](https://img.shields.io/badge/5-Speakers-6C5CE7?style=for-the-badge)
...
graph TD
    ...
    REPO --> ELL["Ellis/<br/>Ellis Whitehead"]
    REPO --> DOR["Dorian/<br/>Dorian Gorski"]
    MATT --> MATT_P["Florence + Seller Sessions"]
    SHUB --> SHUB_P["Stack / Datacore / Brain"]
    DAN --> DAN_P["UI / Remotion / Video Editing"]
    ELL --> ELL_P["Slides + thesis<br/>(Session 1 of 4)"]
    DOR --> DOR_P["syncflow<br/>(Connected Systems pack)"]
    ...
    style ELL fill:none,stroke:#F59E0B,stroke-width:1px,color:#e8e8e8
    style DOR fill:none,stroke:#8B5CF6,stroke-width:1px,color:#e8e8e8
    ...
    style ELL_P fill:none,stroke:#8b949e,stroke-width:1px,color:#cccccc
    style DOR_P fill:none,stroke:#8b949e,stroke-width:1px,color:#cccccc
```
...
| [`Ellis/`](./Ellis) | Ellis Whitehead | Claude as your data engineer, not your analyst |
| [`Dorian/`](./Dorian) | Dorian Gorski | syncflow : Connected Systems Consultant for Amazon brands |
